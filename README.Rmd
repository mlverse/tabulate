...
that support ANSI strings. For a colored version of this table see this [link](https://dfalbel.github.io/tabulate/articles/unicode.html).
...
See the [example gallery](https://dfalbel.github.io/tabulate/articles/) for more.
